...
namespace Leet::Medium {
    ...
    // guaranteed that the new value does not exist in the original BST. Notice that there
    ...
    struct InsertBinaryTree
    {
        Leet::TreeNode *insertIntoBST(Leet::TreeNode *root, int value)
        {
            if (!root) {
                Leet::TreeNode *node = new TreeNode(value);
                return node;
            }
