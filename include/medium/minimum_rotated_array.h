...
namespace Leet::Medium {
    ...
    // sorted rotated array nums of unique elements, return the minimum element
    ...
    struct MinimumRotatedArray
    {
        int findMin(std::vector<int> &nums)
        {
            ...
            while (l < r) {
                ...
                // keep going right until you 'fall of the edge' then go back
                if (nums[mid] > nums[r])
                    l = mid + 1;
                else
                    r = mid;
