...
namespace Leet::Easy {
    ...
    // operations on word. Two integers are considered different if their
    // decimal representations without any leading zeros are different.
    ...
    // Output: 1
    // Explanation: The three integers "1", "01", and "001" all represent the
    // same integer because the leading zeros are ignored when comparing their
    // decimal values.

    // Constraints:
    // 1 <= word.length <= 1000
    // word consists of digits and lowercase English letters.
    struct IntegersInString
    {
