...
namespace Leet::Easy {
    ...
    // bit from the right (a leading zero) to get 10111, etc. Given two integers start and
    // goal, return the minimum number of bit flips to convert start to goal.
    ...
    // Output: 3
    // Explanation: The binary representation of 3 and 4 are 011 and 100 respectively. We
    // can convert 3 to 4 in 3 steps:
